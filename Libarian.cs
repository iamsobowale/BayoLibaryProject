...
namespace Libary_Project
{
    public class Libarian:Person
    {
        ...
        public Libarian(string firstName, string lastName, string phoneNumber, string email,Prefix title):base(firstName, lastName, phoneNumber, email,title)
        {
            IdNumber=GenerateId();
            AddBooks();  
        }
        ...
        {
            Console.WriteLine($"{Title}.{FirstName} Thank you for choosing to work with us, your Id number is {IdNumber}");
        }
