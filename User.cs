...
namespace Libary_Project
{
    public class User:Person
    {
        ...
        public User(string firstName, string lastName, string phoneNumber, string email, Prefix title):base( firstName, lastName, phoneNumber, email, title)
        {
            IdNumber=GenerateId();
            AddStudent();
            NumberOfUsers++;
        ...
        {
            Console.WriteLine($"{Title}.{FirstName} Welcome to Our Libary, your Id number is {IdNumber}");
        }
